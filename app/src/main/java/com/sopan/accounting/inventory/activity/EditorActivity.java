package com.sopan.accounting.inventory.activity;
...
import com.sopan.accounting.inventory.R;
import com.sopan.accounting.inventory.data.ProductContract;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
        ...
        addImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (EasyPermissions.hasPermissions(EditorActivity.this, galleryPermissions)) {
                    ...
                    EasyPermissions.requestPermissions(EditorActivity.this, "Access for storage", GALLERY_PERMISSION_REQUEST_CODE, galleryPermissions);
                }
            }
        });
    ...
    private void saveProduct() {
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_AUTHOR, authorString);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_PUBLISHER, publisherString);
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_ISBN, isbnString);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                ProductContract.ProductEntry.COLUMN_PRODUCT_AUTHOR,
                ProductContract.ProductEntry.COLUMN_PRODUCT_PUBLISHER,
                ProductContract.ProductEntry.COLUMN_PRODUCT_ISBN,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int titleColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_NAME);
            int authorColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_AUTHOR);
            int publisherColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_PUBLISHER);
            int isbnColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_PRODUCT_ISBN);
